...
# cont = itertools.count(0)

# while True:
#     next(cont)
#     r_range = random.randrange(1, 100_000, 1)  # number between 1 and 100_000
#     print(r_range)
#     if r_range == 100:
#         print("100")
#         break
...
# r_randint = random.randint(1, 100_000)  # number between 1 and 100_000
# print(r_randint)


# r_uniform = random.uniform(1, 100_000)  # number between 1 and 100_000
