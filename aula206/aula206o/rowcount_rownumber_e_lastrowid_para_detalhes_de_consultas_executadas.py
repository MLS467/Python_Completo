...
with connection:
    ...
    with connection.cursor() as cursor:
        ...
        print(
            "resultFromSelect", resultFromSelect
        ...
        print(
            "lastrowid na mão", lastIdFromSelect
        )  # retorna o id do último registro inserido

        cursor.scroll(0, "absolute")  # move o cursor para a primeira linha
        print(
            "rownumber", cursor.rownumber
        )  # retorna o número da linha atual do cursor
